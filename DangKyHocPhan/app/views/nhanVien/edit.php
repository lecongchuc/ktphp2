...
<form method="POST" action="/manguonmo/webbanhang/Product/update" onsubmit="return validateForm();">
...
<a href="/manguonmo/webbanhang/Product/list" class="btn btn-secondary mt-2">Quay lại danh sách sản phẩm</a>
